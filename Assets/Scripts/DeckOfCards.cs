...
public class DeckOfCards : MonoBehaviour
{
    ...
    void Start()
    {
        // ??        DeckButton = new GameObject();
        // ??        Debug.Log("DeckButton.transform.position= " + DeckButton.transform.position + "   local=" + DeckButton.transform.localPosition);
...
//            SetMessage(playerName[oppNbr] + " makes " + thisWord + " for " + wordValue + " points,  total = " + playerScore[oppNbr]);
    ...
    {
        turnCount = 0;
//        Debug.Log("oppArea child count=" + oppArea[1].oppWords[0].transform.childCount + "    child 0 =" + oppArea[1].oppWords[0].transform.GetChild(0));

        while (yourHand.transform.childCount > 0)
        {
  //          Debug.Log("Trying to remove " + yourHand.transform.GetChild(0));
        ...
        for (int i = 1; i < players.Length; i++)
        {
            for (int j = 0; j < oppWordCount[i]; j++)
            {
                ...
                {
//                    Debug.Log("Trying to remove " + oppArea[i].oppWords[j].transform.GetChild(0));
        ...
        for (int k = 0; k < wordCount; k++)
        {
            ...
            {
//               Debug.Log("Trying to remove " + tabletop[k].transform.GetChild(0));
        ...
        for (int n = 0; n < players.Length; n++)
        {
            ...
            {
//                Debug.Log("Trying to remove " + discardPiles[n].transform.GetChild(0));
